...
class Solution:
    def leftSideView(self, root):
        ...
        Assumptions -> 
        Edge Cases -> Empty tree, entire tree is left skewed
        Examples ->
            root = [1,2,3,null,5,null,4], output = [1,2,5]
            root = [], output = []
            root = [1,null, 2, 3,4,null,3], output = [1,2, 3]
        Algo ->
        Complexity
        '''
        ...
        queue = []
        #keep track of visible nodes from the left
        visible_nodes = []
        ...
        while (len(queue) != 0):
            ...
            for i in range(0, queue_size):
                ...
                #if the curr node is the FIRST VERTEX on this level, means its the LEFT most
                if (i == 0):
...
solution = Solution()
print(solution.leftSideView(vertex1))

vertex6 = TreeNode(6)
vertex7 = TreeNode(7, vertex6, None)
print(solution.leftSideView(vertex7))
